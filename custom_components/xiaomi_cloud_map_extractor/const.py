...
CONF_AVAILABLE_ATTRIBUTES = [ATTRIBUTE_CALIBRATION, ATTRIBUTE_CHARGER, ATTRIBUTE_COUNTRY, ATTRIBUTE_GOTO,
                             ATTRIBUTE_GOTO_PATH, ATTRIBUTE_GOTO_PREDICTED_PATH, ATTRIBUTE_IMAGE, ATTRIBUTE_IS_EMPTY,
                             ATTRIBUTE_MAP_NAME, ATTRIBUTE_NO_GO_AREAS, ATTRIBUTE_NO_MOPPING_AREAS, ATTRIBUTE_OBSTACLES,
                             ATTRIBUTE_PATH, ATTRIBUTE_ROOM_NUMBERS, ATTRIBUTE_ROOMS, ATTRIBUTE_VACUUM_POSITION,
                             ATTRIBUTE_VACUUM_ROOM, ATTRIBUTE_WALLS, ATTRIBUTE_ZONES]
