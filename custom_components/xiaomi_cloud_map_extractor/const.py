...
CONF_AVAILABLE_ATTRIBUTES = [ATTRIBUTE_CALIBRATION, ATTRIBUTE_CHARGER, ATTRIBUTE_COUNTRY, ATTRIBUTE_GOTO,
                             ATTRIBUTE_GOTO_PATH, ATTRIBUTE_GOTO_PREDICTED_PATH, ATTRIBUTE_IGNORED_OBSTACLES,
                             ATTRIBUTE_IGNORED_OBSTACLES_WITH_PHOTO, ATTRIBUTE_IMAGE, ATTRIBUTE_IS_EMPTY,
                             ATTRIBUTE_MAP_NAME, ATTRIBUTE_NO_GO_AREAS, ATTRIBUTE_NO_MOPPING_AREAS, ATTRIBUTE_OBSTACLES,
                             ATTRIBUTE_OBSTACLES_WITH_PHOTO, ATTRIBUTE_PATH, ATTRIBUTE_ROOMS, ATTRIBUTE_ROOM_NUMBERS,
                             ATTRIBUTE_VACUUM_POSITION, ATTRIBUTE_VACUUM_ROOM, ATTRIBUTE_WALLS, ATTRIBUTE_ZONES]
...
CONF_AVAILABLE_DRAWABLES = [DRAWABLE_ALL, DRAWABLE_CHARGER, DRAWABLE_GOTO_PATH, DRAWABLE_IGNORED_OBSTACLES,
                            DRAWABLE_IGNORED_OBSTACLES_WITH_PHOTO, DRAWABLE_NO_GO_AREAS, DRAWABLE_NO_MOPPING_AREAS,
                            DRAWABLE_OBSTACLES, DRAWABLE_OBSTACLES_WITH_PHOTO, DRAWABLE_PATH, DRAWABLE_PREDICTED_PATH,
...
CONF_AVAILABLE_COLORS = [COLOR_CHARGER, COLOR_GOTO_PATH, COLOR_GREY_WALL, COLOR_IGNORED_OBSTACLE,
                         COLOR_IGNORED_OBSTACLE_WITH_PHOTO, COLOR_MAP_INSIDE, COLOR_MAP_OUTSIDE, COLOR_MAP_WALL,
                         COLOR_MAP_WALL_V2, COLOR_NO_GO_ZONES, COLOR_NO_GO_ZONES_OUTLINE, COLOR_NO_MOPPING_ZONES,
                         COLOR_NO_MOPPING_ZONES_OUTLINE, COLOR_OBSTACLE, COLOR_OBSTACLE_WITH_PHOTO, COLOR_PATH,
                         COLOR_PREDICTED_PATH, COLOR_ROBO, COLOR_SCAN, COLOR_UNKNOWN, COLOR_VIRTUAL_WALLS, COLOR_ZONES,
                         COLOR_ZONES_OUTLINE]
