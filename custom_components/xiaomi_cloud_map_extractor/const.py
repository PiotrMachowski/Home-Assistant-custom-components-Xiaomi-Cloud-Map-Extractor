...
CONF_AVAILABLE_ATTRIBUTES = [ATTRIBUTE_CHARGER, ATTRIBUTE_IMAGE, ATTRIBUTE_VACUUM_POSITION, ATTRIBUTE_PATH,
                             ATTRIBUTE_GOTO_PATH, ATTRIBUTE_GOTO_PREDICTED_PATH, ATTRIBUTE_ZONES, ATTRIBUTE_GOTO,
                             ATTRIBUTE_WALLS, ATTRIBUTE_NO_GO_AREAS, ATTRIBUTE_NO_MOPPING_AREAS, ATTRIBUTE_OBSTACLES]
