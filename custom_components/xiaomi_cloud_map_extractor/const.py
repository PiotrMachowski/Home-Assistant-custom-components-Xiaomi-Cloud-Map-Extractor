...
CONF_AVAILABLE_ATTRIBUTES = [ATTRIBUTE_CALIBRATION, ATTRIBUTE_CHARGER, ATTRIBUTE_IMAGE, ATTRIBUTE_VACUUM_POSITION,
                             ATTRIBUTE_PATH, ATTRIBUTE_GOTO_PATH, ATTRIBUTE_GOTO_PREDICTED_PATH, ATTRIBUTE_ZONES,
                             ATTRIBUTE_GOTO, ATTRIBUTE_WALLS, ATTRIBUTE_NO_GO_AREAS, ATTRIBUTE_NO_MOPPING_AREAS,
                             ATTRIBUTE_OBSTACLES]
...
CONF_AVAILABLE_DRAWABLES = [DRAWABLE_ALL, DRAWABLE_CHARGER, DRAWABLE_PATH, DRAWABLE_GOTO_PATH, DRAWABLE_PREDICTED_PATH,
                            DRAWABLE_NO_GO_AREAS, DRAWABLE_NO_MOPPING_AREAS, DRAWABLE_VACUUM_POSITION,
...
CONF_AVAILABLE_COLORS = [COLOR_MAP_INSIDE, COLOR_MAP_OUTSIDE, COLOR_MAP_WALL, COLOR_MAP_WALL_V2, COLOR_GREY_WALL,
                         COLOR_PATH, COLOR_GOTO_PATH, COLOR_PREDICTED_PATH, COLOR_ZONES, COLOR_ZONES_OUTLINE,
                         COLOR_VIRTUAL_WALLS, COLOR_NO_GO_ZONES, COLOR_NO_GO_ZONES_OUTLINE, COLOR_NO_MOPPING_ZONES,
                         COLOR_UNKNOWN, COLOR_NO_MOPPING_ZONES_OUTLINE, COLOR_CHARGER, COLOR_ROBO, COLOR_SCAN]
